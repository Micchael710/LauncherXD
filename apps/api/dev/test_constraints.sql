...
VALUES ('file-test-1', 'rel-1', 'mods/test.jar', 'test.jar', 'test.jar', 'add', 100, 'sha');

-- Test invalid size (negative)
-- Expect error
INSERT INTO release_files (id, release_id, path, logical_path, filename, operation, size, sha256) 
VALUES ('file-test-2', 'rel-1', 'mods/test2.jar', 'test2.jar', 'test2.jar', 'add', -100, 'sha');

-- Test invalid operation
-- Expect error
INSERT INTO release_files (id, release_id, path, logical_path, filename, operation, size, sha256) 
VALUES ('file-test-3', 'rel-1', 'mods/test3.jar', 'test3.jar', 'test3.jar', 'explode', 100, 'sha');
